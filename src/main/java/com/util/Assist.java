...
public class Assist {
     ...
     *
     * @param require 示例:setRequire(Assist.whereRequire("id",10))
     */
     ...
     * 添加查询条件,参数为Assist的内部类whereRequire,推荐使用Assist的静态条件方法添加条件;
     *
     * @param require 示例:setRequire(Assist.whereRequire("id",10),Assist.whereRequire("id",10)...)
     */
     ...
     *
     * @param customRequire 使用Assist的静态方法Assist.whereRequire获取值
     * @return
     */
     ...
     * 获得一个查询条件
     *
     * <p>示例:Assist.require(" and id in (",1,")");
     *
     * @param condition 条件的SQL语句比如 and id =
     * @param value     条件的值
     * @param suffix    后缀
     ...
     * 获得一个查询条件
     *
     * <p>示例:Assist.require(" and id in (",")",1,2,3,4);
     *
     * @param condition 条件的SQL语句比如 and id =
     * @param suffix    后缀
     * @param values    条件的值
     * @return
     */
    public static <T> WhereRequire<T> whereRequire(
            String condition, String suffix, Object... values) {
        return new Assist().new WhereRequire<T>(condition, suffix, values);
    }

    /**
     * 获得一个排序对象,将(列名)参数1 按 参数2排序(true=ASC/false=DESC),该方法配置setOrder使用,也就是说排序使用setOrder方法参数为该静态方法<br>
     * ;如果表中存在相同列名使用表名.列名,如果不存在相同列名可以直接列名<br>
     *
     * @param column 列名
     ...
     *
     * @param require 示例:Assist.lt("id",10)...
     */
